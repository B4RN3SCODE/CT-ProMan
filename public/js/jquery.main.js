...
function initSlideShow() {
	jQuery('.intro-gallery').fadeGallery({
		slides: '.slide',
		btnPrev: 'a.btn-prev',
		btnNext: 'a.btn-next',
...
function initLightbox() {
	var lightboxActiveClass = 'lightbox-active';
	...
	jQuery('a.lightbox, a[rel*="lightbox"]').each(function() {
		...
		link.fancybox({
			...
			onStart: function() {
				body.addClass(lightboxActiveClass);
			},
			...
			onClosed: function() {
				body.removeClass(lightboxActiveClass);
			}
		});
	});
}
...
// popups init
function initPopups() {
	jQuery('.login-block').contentPopup({
		mode: 'click',
		popup: '.drop',
		btnOpen: '.btn-login',
		openClass: 'active'
	});
	jQuery('.signup-form .row').contentPopup({
		mode: 'click',
		popup: '.popup-signup',
		btnOpen: 'input.popup-open'
	});
}
